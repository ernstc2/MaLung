...
<html lang="en-us">
  <head>
    ...
    <script>
      $(document).ready(function() {
        yelpAPICall("France", "Diving"); //in here, change the first arg to the specific country and second arg to the specific activity
      });
    </script>
  </head>
  ...
  <body>
    ...
    <!-- below this comment, add in some content to basically talk about the activity a little bit -->
